...
<%
List<Product> latestProducts = ProductMgr.getInstance().getLatestProducts(4);
System.out.println(latestProducts.size());
%>
<%
List<Product> categoryidProducts = ProductMgr.getInstance().getCategoryidProducts(4,14);
System.out.println(latestProducts.size());
%>
...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到校园云超市--立志园店！<a href="../login.jsp">请登录</a> | <a href="../register.jsp">免费注册</a></div>
				<div class="tbar_rgt">
					<ul>
						<li class="first"><a href="#">我的订单</a></li>
						<li><a href="#">我的云超市</a></li>
						<li><a href="#">帮助中心</a></li>
						<li><a href="#">联系客服</a></li>
						<li><a href="#">加入收藏</a></li>
						<li class="s_tel_str">服务热线：</li>
						<li class="s_tel">18657107193</li>
					</ul>
				</div>
			</div>
		</div><!--s_tbar end-->
		...
		<div class="s_hd nav">
			<div id="s_logo"><a href="#"><img src="img/logo.jpg" border="0" /></a></div>
			<div id="s_nav">
				<ul>
		...
		<div class="mmenu">
			<div class="s_hd">
				<div id="s_search">
					<form action="" method="post"><input name="" type="text" class="search-input" /><input name="" type="image" src="img/btn_search.jpg" /></form>
				</div>
	...
	<div id="s_bdw">
		<div id="s_bd">
				...
				<div id="i_col_rgt" class="i_col_rgt">
					<div class="i_col_rgt_box">
						...
						<div class="i_slides" id="slideshow">
							<div class="i"><a href="#"><img src="img/slide-1.jpg" /></a></div>
							<div class="i"><a href="#"><img src="img/slide-2.jpg" /></a></div>
							<div class="i"><a href="#"><img src="img/slide-3.jpg" /></a></div>
							<div class="i"><a href="#"><img src="img/slide-4.jpg" /></a></div>
							<div class="i"><a href="#"><img src="img/slide-5.jpg" /></a></div>
						</div>
							...
							<div class="hotp">
								...
								<div class="hot_list">
									<ul>
										...
										<li><a href="#"><img src="img/f5.jpg" /></a></li>
										<li><a href="#"><img src="img/f6.jpg" /></a></li>
										<li><a href="#"><img src="img/f7.jpg" /></a></li>
										<li><a href="#"><img src="img/f8.jpg" /></a></li>
									</ul>
								</div>
						...
						<div class="rgt">
							<div class="rgt-box">
								<div class="loginbox">
									...
									<div class="announce_top cf"><h3>关注云超市<span><a href="#">更多</a></span></h3></div>
			...
			<div class="cf">
				<div class="i_col_lft">
					<div class="i_lads">
						<ul>
							<li><a href="#"><img src="img/lad1.jpg" /></a></li>
							<li><a href="#"><img src="img/lad2.jpg" /></a></li>
							<li><a href="#"><img src="img/lad3.jpg" /></a></li>
						</ul>
					</div>
				</div>
								...
								<dl id="slide-qg">
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg1-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg1-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg1-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg1-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
											<%
											for(Iterator<Product> it = categoryidProducts.iterator();it.hasNext();){
												Product p = it.next();
											%>
											<li>
													<div class="cat_pd">
														<div class="pic"><a href="../productdetailshow.jsp?id=<%= p.getId()%>"><img src="img/qg2-1.jpg" border="0" /></a></div>
														<div class="ptitle"><a href="../productdetailshow.jsp?id=<%= p.getId()%>"><%= p.getName() %></a></div>
														<div class="sprice">特价：<span><%= p.getNormalprice() %></span></div>
													</div>
											</li>
											<%
											}
											%>
												<!-- <li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg2-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg2-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg2-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg2-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg3-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg3-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg3-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg3-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="../productdetailshow.jsp?id=<%= p.getId()%>"><img src="../admin/product/<%= p.getId() %>.jpg" border="0" /></a></div>
														<div class="ptitle"><a href="../productdetailshow.jsp?id=<%= p.getId()%>"><%= p.getName() %></a></div>
														<div class="sprice">特价：<span><%= p.getNormalprice() %></span></div>
													</div>
												</li>
												...
												<!-- <li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg4-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg4-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg4-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="img/qg4-4.jpg" border="0" /></a></div>
							...
							<div class="i_tg">
								...
								<div class="i_tg_cont">
									...
									<div class="i_tg_pic">
										...
										<div class="pic"><a href="#"><img src="img/tg1.jpg" border="0" /></a></div>
									</div>
			...
			<div class="banner2 ptt10 cf"><a href="#"><img src="img/banner1.jpg" border="0" /></a></div>
			...
			<div id="channel_0" class="i_channels cf">
				...
				<div class="i_channels_cont">
					<div class="channel_lft">
						<div class="big_ad_box"><a href="#"><img src="img/cat_ad1.jpg" border="0" /></a></div>
					</div>
					...
					<div class="channel_mid">
						<div class="cat_list_box">
							<ul>
								<li>
									<div class="cat_pd">
										<div class="pic"><a href="#"><img src="img/pd_1_1.jpg" border="0" /></a></div>
								...
								<li>
									<div class="cat_pd">
										<div class="pic"><a href="#"><img src="img/pd_1_2.jpg" border="0" /></a></div>
								...
								<li>
									<div class="cat_pd">
										<div class="pic"><a href="#"><img src="img/pd_1_3.jpg" border="0" /></a></div>
								...
								<li>
									<div class="cat_pd">
										<div class="pic"><a href="#"><img src="img/pd_1_4.jpg" border="0" /></a></div>
					...
					<div class="channel_rgt">
						<div class="small_ad_box">
							<ul>
								<li><a href="#"><img src="img/cat_s_ad1.jpg" border="0" /></a></li>
								<li><a href="#"><img src="img/cat_s_ad2.jpg" border="0" /></a></li>
								<li><a href="#"><img src="img/cat_s_ad3.jpg" border="0" /></a></li>
							</ul>
						</div>
					</div>
			...
			<div class="i_channels_cont">
				<div class="channel_lft">
					<div class="big_ad_box"><a href="#"><img src="img/cat_ad2.jpg" border="0" /></a></div>
				</div>
				<div class="channel_mid">
					<div class="cat_list_box">
						<ul>
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat2-1.jpg" border="0" /></a></div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat2-2.jpg" border="0" /></a></div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat2-3.jpg" border="0" /></a></div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat2-4.jpg" border="0" /></a></div>
				...
				<div class="channel_rgt">
					<div class="small_ad_box">
						<ul>
							<li><a href="#"><img src="img/cat_s_2-1.jpg" width="208" height="63" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_2-2.jpg" width="208" height="63" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad_2_3.jpg" width="203" height="98" border="0" /></a></li>
						</ul>
					</div>
				</div>
		...
		<div id="channel_2" class="i_channels cf">
			...
			<div class="i_channels_cont">
				<div class="channel_lft">
					<div class="big_ad_box"><a href="#"><img src="img/cat_ad3.jpg" border="0" /></a></div>
				</div>
				...
				<div class="channel_mid">
					<div class="cat_list_box">
						<ul>
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat3-1.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">太平 加铁梳打奶盐口味400g 19元选2件</a></div>
									<div class="list_price">¥11.9</div>
									<div class="price">¥9.9</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat3-2.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">农夫山泉 维他命水美丽速度(石榴蓝莓风</a></div>
									<div class="list_price">¥30</div>
									<div class="price">¥20.8</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat3-3.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">丝宝宝 茶树菇145g/袋</a></div>
									<div class="list_price">¥26.5</div>
									<div class="price">¥20.4</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat3-4.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">梅林 午餐肉罐头 340g/罐</a></div>
									<div class="list_price">¥14.5</div>
									<div class="price">¥12.5</div>
								</div>
				...
				<div class="channel_rgt">
					<div class="small_ad_box">
						<ul>
							<li><a href="#"><img src="img/cat_s_ad3-1.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad3-2.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad3-3.jpg" border="0" /></a></li>
						</ul>
					</div>
				</div>
		...
		<div id="channel_3" class="i_channels cf">
			...
			<div class="i_channels_cont">
				<div class="channel_lft">
					<div class="big_ad_box"><a href="#"><img src="img/cat_ad4.jpg" border="0" /></a></div>
				</div>
				...
				<div class="channel_mid">
					<div class="cat_list_box">
						<ul>
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat4-1.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">太平 加铁梳打奶盐口味400g 19元选2件</a></div>
									<div class="list_price">¥11.9</div>
									<div class="price">¥9.9</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat4-2.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">农夫山泉 维他命水美丽速度(石榴蓝莓风</a></div>
									<div class="list_price">¥30</div>
									<div class="price">¥20.8</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat4-3.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">丝宝宝 茶树菇145g/袋</a></div>
									<div class="list_price">¥26.5</div>
									<div class="price">¥20.4</div>
								</div>
							...
							<li>
								<div class="cat_pd">
									<div class="pic"><a href="#"><img src="img/cat4-4.jpg" border="0" /></a></div>
									<div class="ptitle"><a href="#">梅林 午餐肉罐头 340g/罐</a></div>
									<div class="list_price">¥14.5</div>
									<div class="price">¥12.5</div>
								</div>
				...
				<div class="channel_rgt">
					<div class="small_ad_box">
						<ul>
							<li><a href="#"><img src="img/cat_s_ad4-1.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad4-2.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad4-3.jpg" border="0" /></a></li>
						</ul>
					</div>
				</div>
		...
		<div id="channel_4" class="i_channels cf">
			...
			<div class="i_channels_cont">
				<div class="channel_lft">
					<div class="big_ad_box"><a href="#"><img src="img/cat_ad5.jpg" border="0" /></a></div>
				</div>
				...
				<div class="channel_rgt">
					<div class="small_ad_box">
						<ul>
							<li><a href="#"><img src="img/cat_s_ad5-1.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad5-2.jpg" border="0" /></a></li>
							<li><a href="#"><img src="img/cat_s_ad5-3.jpg" border="0" /></a></li>
						</ul>
					</div>
				</div>
	...
	<div id="s_ftw">
		...
		<div id="s_ft">
			...
			<div class="ft_banners1 tac pbt10">
				<ul>
					<li><a href="#"><img src="img/ft_1.gif" border="0" /></a></li>
					<li><a href="#"><img src="img/ft_2.gif" border="0" /></a></li>
					<li><a href="#"><img src="img/ft_3.gif" border="0" /></a></li>
				</ul>
			</div>
			<div class="copyright tac pbt10">版权所有 Copyright&copy; XX商城 All Rights Reserved 版权所有 <a href="http://www.5imoban.net">模板网</a>首页 </div>
			<div class="ft_banners2 tac">
				<ul>
					<li><a href="#"><img src="img/u255.png" border="0" /></a></li>
					<li><a href="#"><img src="img/u257.png" border="0" /></a></li>
					<li><a href="#"><img src="img/u259.png" border="0" /></a></li>
					<li><a href="#"><img src="img/u261.png" border="0" /></a></li>
				</ul>
			</div>
		</div>
